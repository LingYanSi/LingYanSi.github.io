...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sth = __webpack_require__(12);

	var _sth2 = _interopRequireDefault(_sth);

	var _settimeout = __webpack_require__(8);
	...
	// 创建store
	var createStoreWithMiddleware = (0, _redux.applyMiddleware)(_settimeout2.default, _logger2.default)(_redux.createStore);
	var store = createStoreWithMiddleware(_sth2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sth = __webpack_require__(5);

	var _addTodo = __webpack_require__(9);
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_addTodo2.default, {
	          onAddClick: function onAddClick(text) {
	            return dispatch((0, _sth.addTodo)(text));
	          },
	          onFuck: function onFuck(text) {
	            return dispatch((0, _sth.fuck)(text));
	          } }),
	        _react2.default.createElement(_todoList2.default, {
	          todos: this.props.visibleTodos,
	          onTodoClick: function onTodoClick(index) {
	            return dispatch((0, _sth.completeTodo)(index));
	          } }),
	        _react2.default.createElement(_Footer2.default, {
	          visibilityFilter: this.props.visibilityFilter,
	          onShowAll: function onShowAll() {
	            return dispatch((0, _sth.setVisibilityFilter)(_sth.VisibilityFilters.SHOW_ALL));
	          },
	          onShowComplete: function onShowComplete() {
	            return dispatch((0, _sth.setVisibilityFilter)(_sth.VisibilityFilters.SHOW_COMPLETED));
	          },
	          onShowActive: function onShowActive() {
	            return dispatch((0, _sth.setVisibilityFilter)(_sth.VisibilityFilters.SHOW_ACTIVE));
	          } }),
	...
	function selectTodos(todos, filter) {
	  switch (filter) {
	    case _sth.VisibilityFilters.SHOW_ALL:
	      return todos;
	    case _sth.VisibilityFilters.SHOW_COMPLETED:
	      return todos.filter(function (todo) {
	        return todo.completed;
	      });
	    case _sth.VisibilityFilters.SHOW_ACTIVE:
	      return todos.filter(function (todo) {
	        return !todo.completed;
	      });
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Add = exports.Add = function (_Component) {
	    _inherits(Add, _Component);

	    function Add() {
	        _classCallCheck(this, Add);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(Add).call(this));
	    }

	    _createClass(Add, [{
	        key: 'onClick',
	        value: function onClick() {
	            var ele = (0, _reactDom.findDOMNode)(this.refs.input);
	            var text = ele.value;
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    { onClick: this.props.onShowAll,
	                        style: { background: this.getColor('SHOW_ALL') } },
	                    'all'
	                ),
	                _react2.default.createElement(
	                    'button',
	                    { onClick: this.props.onShowComplete,
	                        style: { background: this.getColor('SHOW_COMPLETED') } },
	                    'complete'
	                ),
	                _react2.default.createElement(
	                    'button',
	                    { onClick: this.props.onShowActive,
	                        style: { background: this.getColor('SHOW_ACTIVE') } },
	                    'active'
	                )
	            );
	        }
	    ...
	    _createClass(TodoList, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                'div',
	                null,
	                todos.map(function (ele, index) {
	                    return _react2.default.createElement(
	                        'div',
	                        { onClick: _this2.onClick.bind(_this2, index) },
	                        _react2.default.createElement('input', { type: 'checkbox', checked: ele.completed }),
	                        _react2.default.createElement(
	                            'span',
	                            null,
	                            ele.text
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SHOW_ALL = _sth.VisibilityFilters.SHOW_ALL;
	...
	function visibilityFilter() {
	    ...
	    switch (action.type) {
	        case _sth.SET_VISIBILITY_FILTER:
	...
	function fuck() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? '江泽民' : arguments[0];
	    var action = arguments[1];
