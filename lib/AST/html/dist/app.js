...
/***/ function(module, exports) {
	...
	var H1 = function (_Component2) {
	    ...
	    function H1() {
	        ...
	        return _ret2 = (_temp2 = (_this2 = _possibleConstructorReturn(this, (_ref2 = H1.__proto__ || Object.getPrototypeOf(H1)).call.apply(_ref2, [this].concat(args))), _this2), _this2.template = '<h1 onclick={click} class="center"><Name />{state}</h1>', _this2.data = {
	            state: ' Todo List'
