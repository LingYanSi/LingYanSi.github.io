...
<<<<<<< HEAD
function VDDParser(HTMLStr){
=======
function VDParser(HTMLStr){
	console.log(HTMLStr);
>>>>>>> ca61f0bd58465ef40d6b74c8d76f0f5236b61cdb
    // 生成一个dom数
    HTMLStr = HTMLStr.trim()
    var Dom = []
    let currentNode = null
    HTMLParser(HTMLStr, {
        start: function(tagName, props, unary) {
			...
			//  如果是半闭合标签
			 if(!Parser.empty.includes(tagName)){
	             currentNode = node
			 }
