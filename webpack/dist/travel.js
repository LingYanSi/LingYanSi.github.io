...
/***/ function(module, exports, __webpack_require__) {
	...
	var _moduleFileJsx = __webpack_require__(158);

	var _moduleFileJsx2 = _interopRequireDefault(_moduleFileJsx);

	var _moduleListJsx = __webpack_require__(159);

	var _moduleListJsx2 = _interopRequireDefault(_moduleListJsx);

	var Travel = _react2['default'].createClass({
	    displayName: 'Travel',

	    submit: function submit() {
	        console.log(_moduleFileJsx2['default'].getData());
	    },
	    render: function render() {
	        return _react2['default'].createElement(
	            'div',
	            null,
	            _react2['default'].createElement(_moduleFileJsx2['default'], { name: 'nima', type: 'text', placeholder: '草草啥打法是否' }),
	            _react2['default'].createElement(_moduleFileJsx2['default'], { name: 'nidie', type: 'checkbox' }),
	            _react2['default'].createElement(
	                _moduleListJsx2['default'],
	                null,
	                _react2['default'].createElement(_moduleFileJsx2['default'], { name: 'ri', type: 'select', options: ['什么鬼啊', '卧槽尼玛', '嘿嘿嘿'] })
	            ),
	            _react2['default'].createElement(
	                'button',
	                { onClick: this.submit },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Field = _react2['default'].createClass({
	    ...
	    statics: {
	        ...
	        getData: function getData() {
	            var obj = {};
	            Object.keys(Field.forms).forEach(function (ele) {
	    ...
	    list: function list(type) {
	        ...
	        switch (type) {
	            case 'text':
	                dom = _react2['default'].createElement('input', { type: 'text', defaultvalue: this.state.value, onChange: this.handleChange, placeholder: this.props.placeholder });
	                break;
	            case 'checkbox':
	                dom = _react2['default'].createElement('input', { type: 'checkbox', defaultvalue: this.state.value, onChange: this.handleChange });
	                break;
	            case 'select':
	                var arr = this.props.options.map(function (ele, index) {
	                    return _react2['default'].createElement(
	                        'option',
	                        { value: ele, key: index },
	                        ele
	                ...
	                arr.unshift(_react2['default'].createElement(
	                    'option',
	                    { value: '' },
	                    '选择'
	                ));
	                dom = _react2['default'].createElement(
	                    'select',
	                    { name: '', id: '', onChange: this.handleChange, defaultValue: this.state.value },
	                    arr
	                );
	                break;
	            default:
