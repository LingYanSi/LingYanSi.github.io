	...
	*/
	...
	var About = React.createClass({
	    ...
	    getInitialState: function getInitialState() {
	        return {
	            list: ['西安-秦汉隋唐', '洛阳-汉、魏、晋、北魏', '许昌-魏', '成都-蜀、etc', '南京-吴、东晋、南朝、明、南明、太平天国、民国', '大同-北魏', '开封-北宋', '北京-辽？金、元、明、清、共和国', '银川-西夏', '杭州-南宋', '重庆-民国（抗战）', '延安-土共', '台北-民国', '拉萨-吐蕃', '大理-南诏,大理国?']
	        };
	    },
	...
	ReactDom.render(React.createElement(About, null), document.getElementById('bitch'));
